...
`scripts/local-start.sh` はこのリポジトリ用の Vite PID を `.local/vite.pid` に保存し、`theme/localhost.json` を作成します。LAN IP を検出できた場合は、スマホ確認用の WordPress URL と Vite URL も表示します。
...
開発中は Vite の `assets/images/hero.jpg`、本番では `theme/assets/images/hero.webp` を読みます。
