...
Splide の標準 CSS は `splide` style handle として登録済みです。デザインに合わせて完全に上書きする場合は、Splide の構造 class を使いながら、`assets/scss/object/component` または `assets/scss/object/project` に必要なスタイルを書きます。
