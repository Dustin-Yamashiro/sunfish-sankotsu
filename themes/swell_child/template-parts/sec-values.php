...
<section class="l-sec-values" aria-labelledby="kashikiri-values-title">
	<div class="l-sec-values__inner u-container">
		...
		<ol class="l-sec-values__list">
			<li class="l-sec-values__item u-fade-up">
				<article class="l-sec-values__card">
					<div class="l-sec-values__content">
						<div class="l-sec-values__head">
			...
			<li class="l-sec-values__item u-fade-up">
				<article class="l-sec-values__card">
					<div class="l-sec-values__content">
						<div class="l-sec-values__head">
							<p class="l-sec-values__number">02</p>
							<h3 class="l-sec-values__card-title">初めてでも安心のプランと料金</h3>
						</div>
			...
			<li class="l-sec-values__item u-fade-up">
				<article class="l-sec-values__card">
					<div class="l-sec-values__content">
						<div class="l-sec-values__head">
							<p class="l-sec-values__number">03</p>
							<h3 class="l-sec-values__card-title">散骨後まで続く供養サポート</h3>
						</div>

						<div class="l-sec-values__body">
							<p>故人様らしいお見送りができるよう、ご家族のご希望に合わせて、散骨セレモニーの内容を事前にご相談いただけます。</p>
							<p>さらに、散骨後には、当日の写真・動画やGPS付き証明書のお渡しに加え、四十九日や一周忌といった節目に合わせたメモリアルクルーズにも対応し、海へ還した後も続く供養をお手伝いします。</p>
						</div>
					</div>
