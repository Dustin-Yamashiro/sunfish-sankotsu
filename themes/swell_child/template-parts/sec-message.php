...
<section class="l-sec-message" aria-labelledby="about-message-title">
	<div class="l-sec-message__inner u-container">
		<picture class="l-sec-message__image">
		...
		<div class="l-sec-message__content">
			<div class="l-sec-message__title c-sec-title u-fade-up">
			...
			<p class="l-sec-message__lead">石垣島から海に還る、一番温かいお別れを。</p>

			<div class="l-sec-message__body">
				<p>テストテストテストテストテストテストテストテストテストテストテストテストテストテストテストテスト。</p>
				<p>テストテストテストテストテストテストテストテストテストテストテストテストテストテストテストテスト。</p>
				<p>テストテストテストテストテストテストテストテストテストテストテストテストテストテストテストテスト。</p>
			</div>

			<p class="l-sec-message__name">代表 / 船長　浜 佑介</p>
		</div>
	</div>
</section>
