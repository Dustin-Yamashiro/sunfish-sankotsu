...
?>
<section class="l-sec-news" aria-labelledby="front-news-title">
		...
		<div class="l-sec-news__list">
			<?php if ( $sec_news_query->have_posts() ) : ?>
				<?php while ( $sec_news_query->have_posts() ) : ?>
					...
					?>
						<article class="l-sec-news__item" aria-labelledby="<?php echo esc_attr( $sec_news_item_id ); ?>">
							<a class="l-sec-news__link" href="<?php echo esc_url( get_permalink() ); ?>">
								<span class="l-sec-news__meta">
									...
									<?php if ( $sec_news_term ) : ?>
										<span class="l-sec-news__category"><?php echo esc_html( $sec_news_term->name ); ?></span>
									<?php endif; ?>
								</span>
								<h3 id="<?php echo esc_attr( $sec_news_item_id ); ?>" class="l-sec-news__item-title"><?php echo esc_html( get_the_title() ); ?></h3>
							</a>
						</article>
				<?php endwhile; ?>
